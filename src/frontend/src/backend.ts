...
export class Backend implements backendInterface {
    ...
    async getLeaderboard(): Promise<Array<PlayerProgress>> {
    ...
    async loadGameProgress(): Promise<PlayerProgress> {
        if (this.processError) {
            try {
                const result = await this.actor.loadGameProgress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveGameProgress(arg0: bigint, arg1: bigint, arg2: Array<bigint>, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
